      ...
      <div className="welcome__header">
        ...
        <span>
          ...
          <p style={{ maxWidth: "480px", marginBottom: "2rem", opacity: 0.5 }}>
            Your Amazon Account is created and we would like to know a little
            bit more about yourself. You may still want to confirm your email
            address to login next time.
          </p>
        </span>
      </div>
